...
{
    class FATORA_WC_GATEWAY extends WC_Payment_Gateway
    {
        public function __construct()
        {
            ...
            $this->method_title = 'Fatora Gateway';
            $this->method_description = 'Pay with Fatora';
            ...
            add_action('woocommerce_api_fatora_payment_confirmation', array($this, 'payment_confirmation'));
        }
        ...
        {
            return $this->testmode == "no" ? 'https://egate-t.fatora.me/api' : 'https://egate.fatora.me/api';
        }
